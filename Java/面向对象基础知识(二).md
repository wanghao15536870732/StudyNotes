...
+ [String类的基本概念](String类的基本概念)
  + [为String类对象直接赋值](为String类对象直接赋值)
  + [利用构造方法实例化](利用构造方法实例化)
  + [在String对象上使用“==”比较](在String对象上使用“==”比较)
...
+ [String类的常用方法](String类的常用方法)
  ...
  + [使用indexOf()等功能查找](使用indexOf()等功能查找)
  + [利用indexOf()方法判断子字符串是否存在](利用indexOf()方法判断子字符串是否存在)
  + [使用contains()方法判断子字符串是否存在](使用contains()方法判断子字符串是否存在)
  + [开头或结尾判断 startsWith()、 startsWith()](开头或结尾判断)
  + [观察替换的结果 replaceAll()、replaceFirst()](观察替换的结果)
  + [截取数据](截取数据)
  + [字符串拆分单词](字符串拆分单词)
  + [字符串拆分字母](字符串拆分字母)
  + [拆分为指定的个数](拆分为指定的个数)
