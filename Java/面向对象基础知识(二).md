...
+ [`String 类的常用方法`](#String类的常用方法)
  ...
  + [`使用 indexOf() 方法功能查找`](#使用indexOf()等功能查找)
  + [`利用 indexOf() 方法判断子字符串是否存在`](#利用indexOf()方法判断子字符串是否存在)
  + [`使用 contains() 方法判断子字符串是否存在`](#使用contains()方法判断子字符串是否存在)
